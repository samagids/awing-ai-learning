...
class _ProfileSelectScreenState extends State<ProfileSelectScreen> {
  ...
  Future<bool> _showAccountPinDialog(AuthService auth) async {
      ...
      builder: (ctx) => AlertDialog(
        title: Row(
          children: [
            ...
            const Expanded(
              child: Text('Account PIN', style: TextStyle(fontSize: 18)),
            ),
          ],
        ),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Text('Enter the account PIN to switch profiles.'),
            const SizedBox(height: 16),
            TextField(
